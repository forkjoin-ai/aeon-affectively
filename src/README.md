...
Parent: [Aeon Affectively](../README.md)

Source module for the Src feature area.

## Key Files

- `compressor-cascade.ts`: Source file in this module.
- `compressor-cascade.verify.ts`: Source file in this module.
- `index.ts`: Public entrypoint or module barrel.
